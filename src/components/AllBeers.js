        ...
        return(
            <section>
                ...
                <AllBeersContainer background={background}>
                    {Object.keys(beers).map((key)=> <BeerItem deleteBeer={deleteBeer} details={beers[key]} handleChange={this.handleChange} index={key} like={like} pint={pint} plus = {plus} toggleOpen={this.toggleOpen}/>)}
                    <AddBeer onClick={()=>{
                        toggle(2)
